...
public abstract class LuminanceSource {
     ...
     * be ignored. Always use the returned object, and ignore the .length of the
     * array.
     ...
     * result.length as it may be larger than width * height bytes on some
     * platforms. Do not modify the contents of the result.
     */
     ...
     * luminances it returns -- black becomes white and vice versa, and each
